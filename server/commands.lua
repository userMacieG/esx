...
ESX.RegisterCommand('setaccountmoney', 'staff_level_5', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
		args.playerId.setAccountMoney(args.account, args.amount, 'setaccountmoney command')
	else
...
ESX.RegisterCommand('giveaccountmoney', 'staff_level_5', function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
		args.playerId.addAccountMoney(args.account, args.amount, 'giveaccountmoney command')
	else
		showError(_U('command_giveaccountmoney_invalid'))
	end
